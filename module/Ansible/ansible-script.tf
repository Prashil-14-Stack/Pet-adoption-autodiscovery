...
sudo echo "${file(var.staging-MyPlaybook)}" >> /etc/ansible/stage-env-playbook.yml 
sudo echo "${file(var.staging-discovery-script)}" >> /etc/ansible/stage-env-bash-script.sh
sudo echo "${file(var.prod-MyPlaybook)}" >> /etc/ansible/prod-env-playbook.yml
sudo echo "${file(var.prod-discovery-script)}" >> /etc/ansible/prod-env-bash-script.sh 
sudo echo "${var.private_key}" >> /etc/ansible/key.pem
...
sudo chmod 755 /etc/ansible/stage-env-bash-script.sh 
sudo chmod 755 /etc/ansible/prod-env-bash-script.sh
